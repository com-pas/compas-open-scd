...
CompasSaveMenuPlugin.styles = css`
    mwc-dialog {
...
__decorate([
  property()
], CompasSaveMenuPlugin.prototype, "doc", 2);
__decorate([
  property()
], CompasSaveMenuPlugin.prototype, "docName", 2);
__decorate([
  property()
], CompasSaveMenuPlugin.prototype, "docId", 2);
__decorate([
  property({type: Number})
], CompasSaveMenuPlugin.prototype, "editCount", 2);
__decorate([
  query("mwc-dialog#compas-save-dlg")
], CompasSaveMenuPlugin.prototype, "dialog", 2);
__decorate([
  query("compas-save")
], CompasSaveMenuPlugin.prototype, "compasSaveElement", 2);

...
import { find, getReference, getValue, identity, isPublic, newSubWizardEvent, newWizardEvent, } from '../../../_snowpack/pkg/@compas-oscd/open-scd/dist/foundation.js';
    ...
    return [
        {
          ...
          >${reportControls.map(reportControl => oscdHtml `<mwc-list-item twoline value="${identity(reportControl)}"

...
import '../../../_snowpack/pkg/@compas-oscd/open-scd/dist/wizard-checkbox.js';
import '../../../_snowpack/pkg/@compas-oscd/open-scd/dist/wizard-textfield.js';
import '../../../_snowpack/pkg/@compas-oscd/open-scd/dist/wizard-select.js';
import '../../../_snowpack/pkg/@compas-oscd/open-scd/filtered-list.js';
import { find, getValue, identity, isPublic, newSubWizardEvent, newWizardEvent, } from '../../../_snowpack/pkg/@compas-oscd/open-scd/dist/foundation.js';
...
function contentSampledValueControlWizard(options) {
    ...
    ></wizard-textfield>`,
      ...
      >${smpModEnum.map(option => oscdHtml `<mwc-list-item value="${option}">${option}</mwc-list-item>`)}</wizard-select
    >`,
        oscdHtml `<wizard-textfield
      label="smpRate"
    ...
    ></wizard-textfield>`,
      ...
      >${securityEnabledEnum.map(option => oscdHtml `<mwc-list-item value="${option}">${option}</mwc-list-item>`)}</wizard-select
    >`,
    ];
}
    ...
    return [
        {
          ...
          >${smvControls.map(smvControl => oscdHtml `<mwc-list-item twoline value="${identity(smvControl)}"

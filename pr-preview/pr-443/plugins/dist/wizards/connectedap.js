...
import { compareNames, getValue, isPublic, identity, } from '../../../_snowpack/pkg/@compas-oscd/open-scd/dist/foundation.js';
...
export function editConnectedApWizard(element) {
    return [
        ...
        ${getTypes(element).map(pType => oscdHtml `${createPTextField(element, pType)}`)}`,
            ],
        },
    ];
}

const iec6185074 = fetch('public/xml/IEC_61850-7-4_2007B5.nsd')
    .then(response => response.text())
    .then(str => new DOMParser().parseFromString(str, 'application/xml'));
const iec6185073 = fetch('public/xml/IEC_61850-7-3_2007B5.nsd')
    .then(response => response.text())
    .then(str => new DOMParser().parseFromString(str, 'application/xml'));
const iec6185072 = fetch('public/xml/IEC_61850-7-2_2007B5.nsd')
    .then(response => response.text())
    .then(str => new DOMParser().parseFromString(str, 'application/xml'));
...
export { iec6185072 as a, iec6185073 as b, iec6185074 as c, iec6185081 as d, initializeNsdoc as i };

export const officialPlugins = [
  ...
  },
  {
    ...
    src: 'https://transnetbw-openscd.github.io/compas-transnetbw-plugins/bearingpoint/compas/plugins/engineering-wizard/1.0.0/index.js',
    icon: 'star',
    activeByDefault: true,
    kind: 'editor',
    requireDoc: true,
  ...
  {
    name: 'Template Generator',
    src: 'https://transnetbw-openscd.github.io/compas-transnetbw-plugins/bearingpoint/compas/plugins/template-generator/1.0.0/index.js',
    icon: 'copy_all',
    activeByDefault: true,
    kind: 'editor',
    requireDoc: true,
